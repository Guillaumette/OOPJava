package exceptions.seminar3.homework.core.model;

import exceptions.seminar3.homework.core.data.Data;
...
public class Model {
    ...
    private void write() {
        String path = "D:\\Documents\\Программирование\\GeekBrains курс\\1 четверть\\OOP_Java" +
                "\\src\\main\\resources\\" + data.getLastName().toLowerCase() + ".txt";
